    ...
    <div className="grid grid-cols-[116px_repeat(2,1fr)] pt-22 gap-2 items-center">
      ...
      <div className="flex flex-col items-center gap-4 p-4">
        ...
        <p className=' font-light'>
				...
				skills and expertise to create stunning and fully responsive applications.
			</p>
      </div>
      <div className="p-4" ><img src="/laptop.jpg" alt="Laptop" className="object-cover w-full h-full rounded-lg" /></div>
    </div>
  )
}
