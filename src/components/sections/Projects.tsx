        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl border border-black hover:-translate-y-1 transition">
            ...
            <p className="text-black mb-4">
              ...
              centralized banking identity solution. Through Paydeet, users can
              seamlessly link multiple bank accounts using a single, dynamically
              generated link.
            </p>
          ...
          <div className="p-6 rounded-xl border border-black hover:-translate-y-1 transition">
            ...
            <p className="text-black mb-4">
              Health-tech product that allows users to get access to verified
              medical experts through the app
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
              {["React.js", "Node.js", "MySQL", "TypeScript"].map(
                (tech, key) => (
                  <span
                    key={key}
                    className="bg-gray-300 text-black py-1 px-3 rounded-full text-sm hover:bg-black/25 
